    ...
    return (
      <div className="BioPage">
        ...
        <div className="my-story-container">
          <h4 className="header">My Story</h4>
          <hr class="solid"></hr>
          <p className="p">
        ...
        <div className="why-dev">
          <h4 className="header">Why Web development?</h4>
          <hr class="solid"></hr>
          <p className="p">
        ...
        <div className="love-dev">
          <h4 className="header">What do i love about development?</h4>
          <hr class="solid"></hr>
          <p className="p">
        ...
        <div className="good-dev">
          <h4 className="header">What makes me a good developer?</h4>
          <hr class="solid"></hr>
          <p className="p">
